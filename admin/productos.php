...
if (isset($_POST)) {
    if (!empty($_POST)) {
        ...
        $query = mysqli_query($conexion, "INSERT INTO productos(nombre, descripcion, precio_normal,cantidad, imagen, id_categoria) VALUES ('$nombre', '$descripcion', '$p_normal', $cantidad, '$foto', $categoria)");
        if ($query) {
