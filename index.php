...
<head>
    ...
    <title>SuperForaneo</title>
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="assets/tienda.png" />
    <!-- Bootstrap icons-->
...
<body>
    <a href="#" class="btn-flotante" id="btnCarrito">Carrito <span class="badge bg-info" id="carrito">0</span></a>
    <!-- Navigation-->
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <!--<a class="navbar-brand" href="#">SuperForaneo</a>-->
                <a class="navbar-brand" href="admin/index.php">
                    <button class="btn btn-info">Login</button></a>
    ...
    <!-- Header-->
    <header class="background-color: pink; py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-black">
                <h1 class="display-4 fw-bolder">SuperForaneo</h1>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">¡Felices fiestas!</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
